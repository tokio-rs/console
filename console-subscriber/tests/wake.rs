...
impl ExpectedTask {
    ...
    fn matches_actual_task(&self, actual_task: &ActualTask) -> bool {
    ...
    fn validate_actual_task(&self, actual_task: &ActualTask) -> bool {
    ...
    fn match_name(mut self, name: String) -> Self {
        self.match_name = Some(name);
        self
    }

    fn expect_wakes(mut self, wakes: u64) -> Self {
        self.expect_wakes = Some(wakes);
        self
    }

    fn expect_self_wakes(mut self, self_wakes: u64) -> Self {
