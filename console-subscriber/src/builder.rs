...
// TODO: turn this into an opaque type so we can change internal layers?
...
impl Builder {
    ...
    pub fn spawn(self) -> ConsoleSubscriberLayer {
...
///
/// The builder can be configured before being initialized. This is a
/// convenient way of calling `Builder::default().with_default_env()`.
pub fn builder() -> Builder {
    Builder::default().with_default_env()
}
